s|TAG_META_MOVIE_NAME|Yaariyan|g
s|TAG_FILENAME_YEAR|2008|g
s|TAG_GENRE||g
#
s|TAG_MOVIE_RELEASE_DATE||g
s|TAG_MOVIE_DIRECTED_BY|Deepak Grewal|g
#
s|TAG_FILENAME_MOVIE_NAME|yaariyan|g
s|TAG_IMAGE_NAME|coming_soon|g
#
s|TAG_ALT_MOVIE_NAME|Yaariyan|g
s|TAG_TITLE_MOVIE_NAME|Yaariyan|g
#
s|TAG_CAST_ACTOR_1|Om Puri|g
s|TAG_FILENAME_CAST_ACTOR_1|om_puri|g
#
s|TAG_CAST_ACTRESS_1|Bhumika Chawla|g
s|TAG_FILENAME_CAST_ACTRESS_1|bhumika_chawla|g
#
s|TAG_CAST_ACTOR_OTHERS|Gurdas Mann, Gulshan Grover, Asrani, |g
...
#
s|TAG_TORRENT_HTML_1|Yaariyan+movie|g
s|TAG_TORRENT_1|Google Movie Search|g
#
s|TAG_TORRENT_HTML_3|http://mbt.searching.com/?keywords=Yaariyan|g
s|TAG_TORRENT_3|My BitTorrents|g
#
s|TAG_MP3_HTML_1|Yaariyan+music|g
