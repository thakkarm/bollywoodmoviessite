s|TAG_META_MOVIE_NAME|Bhootnath|g
s|TAG_FILENAME_YEAR|2006|g
s|TAG_GENRE|NEED_TO_UPDATE|g
#
s|TAG_MOVIE_RELEASE_DATE|NEED_TO_UPDATE|g
s|TAG_MOVIE_DIRECTED_BY|Vivek Sharma|g
#
s|TAG_FILENAME_MOVIE_NAME|bhootnath|g
s|TAG_IMAGE_NAME|coming_soon|g
#
s|TAG_ALT_MOVIE_NAME|Bhootnath|g
s|TAG_TITLE_MOVIE_NAME|Bhootnath|g
#
...
#
s|TAG_TORRENT_HTML_1|Bhootnath+movie|g
s|TAG_TORRENT_1|Google Movie Search|g
#
s|TAG_TORRENT_HTML_3|http://mbt.searching.com/?keywords=Bhootnath|g
s|TAG_TORRENT_3|My BitTorrents|g
#
s|TAG_MP3_HTML_1|Bhootnath+music|g
