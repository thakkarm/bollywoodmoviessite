...
F:\__site\tools\ssed.exe -f to_celebrites.sed template_biography.html > template_celebrites_biography.html
F:\__site\tools\ssed.exe -f to_celebrites.sed template_latest_news.html > template_celebrites_latest_news.html

F:\__site\tools\ssed.exe -f to_celebrites.sed template_filmography_page.html > template_celebrites_filmography.html 
