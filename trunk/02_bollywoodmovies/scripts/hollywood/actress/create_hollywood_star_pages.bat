...
F:\__site\tools\ssed.exe -f %2.sed -f %2_bio.sed -f common_film.sed -f common_hollywood.sed template_hollywood_filmography.html > C:\_Files\hollywood\%1\%2\hollywood_%2_filmography.html
