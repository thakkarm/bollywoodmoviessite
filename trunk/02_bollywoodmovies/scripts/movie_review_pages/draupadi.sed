s|TAG_META_MOVIE_NAME|Draupadi|g
s|TAG_FILENAME_YEAR|2007|g
s|TAG_GENRE|NEED_TO_UPDATE|g
#
s|TAG_MOVIE_RELEASE_DATE|NEED_TO_UPDATE|g
s|TAG_MOVIE_DIRECTED_BY|Rituparno Ghosh|g
#
s|TAG_FILENAME_MOVIE_NAME|draupadi|g
s|TAG_IMAGE_NAME|coming_soon|g
#
s|TAG_ALT_MOVIE_NAME|Draupadi|g
s|TAG_TITLE_MOVIE_NAME|Draupadi|g
#
...
#
s|TAG_TORRENT_HTML_1|Draupadi+movie|g
s|TAG_TORRENT_1|Google Movie Search|g
#
s|TAG_TORRENT_HTML_3|http://mbt.searching.com/?keywords=Draupadi|g
s|TAG_TORRENT_3|My BitTorrents|g
#
s|TAG_MP3_HTML_1|Draupadi+music|g
