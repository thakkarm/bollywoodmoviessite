s|TAG_META_MOVIE_NAME|7 Days In Paris|g
s|TAG_FILENAME_YEAR|2009|g
s|TAG_GENRE|Romance|g
#
s|TAG_MOVIE_RELEASE_DATE||g
s|TAG_MOVIE_DIRECTED_BY|Sanjay Gadhvi|g
#
s|TAG_FILENAME_MOVIE_NAME|7_days_in_paris|g
s|TAG_IMAGE_NAME|coming_soon|g
#
s|TAG_ALT_MOVIE_NAME|7 Days In Paris|g
s|TAG_TITLE_MOVIE_NAME|7 Days In Paris|g
#
...
#
s|TAG_TORRENT_HTML_1|7+Days+In+Paris+movie|g
s|TAG_TORRENT_1|Google Movie Search|g
#
s|TAG_TORRENT_HTML_3|http://mbt.searching.com/?keywords=7+Days+In+Paris|g
s|TAG_TORRENT_3|My BitTorrents|g
#
s|TAG_MP3_HTML_1|7+Days+In+Paris+music|g
