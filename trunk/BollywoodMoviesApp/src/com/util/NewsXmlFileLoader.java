...
//----------------------------------------------------------------------------
class LoadNewsConfigurationTask extends AsyncTask<String, Integer, Bitmap> {
	...
	protected void onPostExecute(Bitmap img) {
		Configuration.getInstance().loadNewsConfigPostRead();
	}
...
// ----------------------------------------------------------------------------
public class NewsXmlFileLoader {

	public void loadXMLFromURL(String urlString, DefaultHandler xmlHandler)
			throws XMLFileLoaderException {
		LoadNewsConfigurationTask loadNewsConfigurationTask = new LoadNewsConfigurationTask();
		loadNewsConfigurationTask.m_xmlHandler = xmlHandler;
		loadNewsConfigurationTask.execute(urlString);
	}
}
